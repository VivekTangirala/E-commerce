...
//
//     final searchapi = searchapiFromJson(jsonString);

import 'dart:convert';

List<Searchapi> searchapiFromJson(String str) => List<Searchapi>.from(json.decode(str).map((x) => Searchapi.fromJson(x)));

String searchapiToJson(List<Searchapi> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
