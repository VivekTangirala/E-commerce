...
List<Categorydetails> categorydetailsFromJson(String str) => List<Categorydetails>.from(json.decode(str).map((x) => Categorydetails.fromJson(x)));

String categorydetailsToJson(List<Categorydetails> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
